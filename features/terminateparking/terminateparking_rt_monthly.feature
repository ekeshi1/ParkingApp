Feature: Terminate parking
    ...
    Scenario: Terminating parking with real-time payment and monthly debit
    Given I have configured "Pay monthly" in my profile
    ...
    Then I should see an invoice with status "UNPAID" on the screen.
